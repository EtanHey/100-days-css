    ...
    <header className="flex sticky top-0 z-50 h-fit w-full flex-row items-center bg-[#6B329F] px-3 py-4 font-bold text-white">
      <nav className="center">
        <ul className="flex flex-wrap items-center justify-center gap-y-2">
          ...
          <li>
            <Link href="/day-47" className="px-3 py-1 text-sm uppercase">
              Day 47
            </Link>
          </li>
          <li>
            <Link href="/day-48" className="px-3 py-1 text-sm uppercase">
              Day 48
            </Link>
          </li>
          <li>
            <Link href="/day-50" className="px-3 py-1 text-sm uppercase">
              Day 50
            </Link>
          </li>
        </ul>
