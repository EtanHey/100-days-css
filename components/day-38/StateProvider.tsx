...
const StateProvider = () => {
  ...
  return (
    <span className="absolute top-1/2 left-1/2 -ml-[200px] -mt-[200px] flex h-[400px] w-[400px] cursor-pointer items-center justify-center overflow-hidden rounded-sm bg-[#9B59B6] text-white shadow-thirtySixthFrame">
